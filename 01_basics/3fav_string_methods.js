...
// console.log(str.startsWith('hello'));               // return true or false if string is starting with it   
// console.log(str.endsWith('rajput'));                // same as above but for ending
...
// console.log(str.trim());                            // trim the whitespaces from start and end